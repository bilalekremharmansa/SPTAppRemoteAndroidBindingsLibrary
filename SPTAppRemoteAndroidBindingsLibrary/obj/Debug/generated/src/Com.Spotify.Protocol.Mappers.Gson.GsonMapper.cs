...
namespace Com.Spotify.Protocol.Mappers.Gson {

	// Metadata.xml XPath class reference: path="/api/package[@name='com.spotify.protocol.mappers.gson']/class[@name='GsonMapper']"
	[global::Android.Runtime.Register ("com/spotify/protocol/mappers/gson/GsonMapper", DoNotGenerateAcw=true)]
	public partial class GsonMapper : global::Java.Lang.Object, global::Com.Spotify.Protocol.Mappers.IJsonMapper {

		internal    new     static  readonly    JniPeerMembers  _members    = new XAPeerMembers ("com/spotify/protocol/mappers/gson/GsonMapper", typeof (GsonMapper));
		...
		protected GsonMapper (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		// Metadata.xml XPath method reference: path="/api/package[@name='com.spotify.protocol.mappers.gson']/class[@name='GsonMapper']/method[@name='create' and count(parameter)=0]"
		[Register ("create", "()Lcom/spotify/protocol/mappers/gson/GsonMapper;", "")]
		public static unsafe global::Com.Spotify.Protocol.Mappers.Gson.GsonMapper Create ()
		{
			const string __id = "create.()Lcom/spotify/protocol/mappers/gson/GsonMapper;";
			try {
				var __rm = _members.StaticMethods.InvokeObjectMethod (__id, null);
				return global::Java.Lang.Object.GetObject<global::Com.Spotify.Protocol.Mappers.Gson.GsonMapper> (__rm.Handle, JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}
...
#pragma warning disable 0169
		...
		{
			global::Com.Spotify.Protocol.Mappers.Gson.GsonMapper __this = global::Java.Lang.Object.GetObject<global::Com.Spotify.Protocol.Mappers.Gson.GsonMapper> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.spotify.protocol.mappers.gson']/class[@name='GsonMapper']/method[@name='toJson' and count(parameter)=1 and parameter[1][@type='java.lang.Object']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.spotify.protocol.mappers.gson']/class[@name='GsonMapper']/method[@name='toJsonArray' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
